...
public class Structures {
	public static Structure gridStructure(Wireframe wireframe, String name, Class<? extends StructureContentBuilder> builderClass) {
		WireframeNode root = new WireframeNode(wireframe, name, builderClass, WireframeLayoutType.GRID);
		return new Structure(root);
	}

	public static Structure emptyStructure(Wireframe wireframe, String name, Class<? extends StructureContentBuilder> builderClass) {
		WireframeNode root = new WireframeNode(wireframe, name, builderClass, WireframeLayoutType.EMPTY);
		return new Structure(root);
	}

	public static Structure layeredStructure(Wireframe wireframe, String name, Class<? extends StructureContentBuilder> builderClass) {
		WireframeNode root = new WireframeNode(wireframe, name, builderClass, WireframeLayoutType.LAYERS);
		return new Structure(root);
	}

	public static Structure simpleStructure(Wireframe wireframe, String name, Class<? extends StructureContentBuilder> builderClass) {
