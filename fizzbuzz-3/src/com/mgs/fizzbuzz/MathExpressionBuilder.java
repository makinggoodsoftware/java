...
public class MathExpressionBuilder {
	private final MathExpert mathExpert;

	public MathExpressionBuilder(MathExpert mathExpert) {
	...
	public class Operation {
		...
		public boolean containingTheDigit(int digitToContain) {
			return mathExpert.contains(on, digitToContain);
		}
	}
}
