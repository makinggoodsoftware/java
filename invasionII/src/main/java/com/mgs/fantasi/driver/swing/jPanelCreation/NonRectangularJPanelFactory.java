...
public class NonRectangularJPanelFactory implements JPanelFactory {
	@Override
	public JPanel create(WireframeLayoutType layoutType, UIPropertiesProvider uiProperties, JPanelLayoutTranslator jPanelLayoutTranslator, List<StandardJPanelDto.JPanelChild> children, PolygonPointsIterator shape) {
