...
public class AllUndefinedUIPropertiesBuilder implements UIPropertiesBuilder {
	private UIProperty<Border> border = UIPropertyFactory.undefined(PropertyType.BORDER);
	private UIProperty<Color> backgroundColor = UIPropertyFactory.undefined(PropertyType.FOREGROUND_COLOR);
	private UIProperty<Color> foregroundColor = UIPropertyFactory.undefined(PropertyType.FOREGROUND_COLOR);
	private UIProperty<Padding> padding = UIPropertyFactory.undefined(PropertyType.PADDING);
	private UIProperty<PolygonPointsIterator> shape = UIPropertyFactory.undefined(PropertyType.SHAPE);
	private UIProperty<Measurement> measurement = UIPropertyFactory.undefined(PropertyType.MEASUREMENT);
